...
- 🔒 **Comunicação Segura**: Alternativas ao Gmail, WhatsApp e Google Meet
- 📁 **Armazenamento Seguro**: Soluções que não dependem de Big Techs
- 🔑 **Autenticação e Senhas**: Gerenciamento seguro de credenciais
- 🛡️ **Proteção Contra Ataques**: Prevenção e resposta a ameaças digitais
- 🌐 **Trabalho Remoto Seguro**: VPN e controle de acesso para equipes distribuídas
- 📋 **Checklist de Segurança**: Ferramenta prática para avaliação organizacional
- 📚 **Guias Práticos**: Passo a passo para configuração de ferramentas essenciais

## Acesse o Manual Completo

📖 **[Leia o manual completo aqui](./Manual-Seguranca-Digital-Litigancia-BigTech.md)**

## Quem Deve Usar Este Manual

- Organizações de defesa de direitos humanos
- Grupos envolvidos em Ações Civis Públicas contra Big Techs
- Coletivos que atuam em advocacy digital
- Organizações parceiras em litigância estratégica
- Qualquer grupo que precise proteger informações estratégicas de vigilância corporativa

## Autoria

**Código Não Binário**

- 🌐 Website: [www.codigonaobinario.org](https://www.codigonaobinario.org)
- ✉️ Contato: contato@codigonaobinario.org
...
Sugestões, correções e melhorias são sempre apreciadas.
...
- [SaferNet Brasil](https://safernet.org.br) - Suporte jurídico e técnico para crimes digitais
- [Access Now](https://accessnow.org) - Assistência técnica em segurança digital
- [Tactical Tech](https://tacticaltech.org) - Guias sobre privacidade e segurança online
- [EFF - Guia de Autodefesa Contra Vigilância](https://ssd.eff.org/pt-br) - Guia completo sobre privacidade e segurança digital
